...
import io.agents.arya.ui.settings.LlmConfigActivity
...
class ComposeChatActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Check for updates
        io.agents.arya.utils.UpdateChecker.checkForUpdate(this)
        ...
        // Usage: adb shell am start -n io.agents.arya/.ui.chat.ComposeChatActivity --es task "open my camera"
