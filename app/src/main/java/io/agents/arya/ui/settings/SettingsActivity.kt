...
""".trimIndent(),
            ...
            AlertDialog.show(
                ...
                onCancel = {
                    shareReportFile(
                        ...
                        subject = "PokeClaw bug report ${io.agents.arya.BuildConfig.VERSION_NAME}",
                        body = """
    ...
    private fun shareDebugReport() {
        buildSupportBundle(
            ...
            shareReportFile(
                ...
                subject = "PokeClaw debug report ${io.agents.arya.BuildConfig.VERSION_NAME}",
    ...
    private fun buildGitHubIssueBody(report: java.io.File): String {
        return """
            ...
            Generated by PokeClaw ${io.agents.arya.BuildConfig.VERSION_NAME}.
        """.trimIndent()
    }
