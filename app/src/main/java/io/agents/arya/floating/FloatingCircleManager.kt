...
package io.agents.arya.floating
...
object FloatingCircleManager {
    ...
    private var currentTokenState: io.agents.arya.agent.TokenMonitor.State = io.agents.arya.agent.TokenMonitor.State.NORMAL
     ...
     */
    fun updateTokenStatus(step: Int, formattedTokens: String, formattedCost: String, tokenState: io.agents.arya.agent.TokenMonitor.State) {
        ThreadUtils.runOnUiThread {
            currentRound = step
            ...
            val colorRes = when (tokenState) {
                io.agents.arya.agent.TokenMonitor.State.NORMAL -> R.color.colorBrandPrimary
                io.agents.arya.agent.TokenMonitor.State.CAUTION -> R.color.colorWarningPrimary
                io.agents.arya.agent.TokenMonitor.State.WARNING -> R.color.colorWarningPrimary
                io.agents.arya.agent.TokenMonitor.State.CRITICAL -> R.color.colorErrorPrimary
            }
            try {
