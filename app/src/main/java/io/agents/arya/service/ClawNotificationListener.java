...
public class ClawNotificationListener extends NotificationListenerService {
    ...
    static {
        ...
        MESSAGING_APPS.add("org.thunderdog.challegram"); // Telegram X
    ...
    private void maybeReturnToAppAfterPermissionFlow() {
        ...
        mainHandler.postDelayed(() -> {
            try {
                android.content.Intent intent = new android.content.Intent(this, io.agents.arya.ui.settings.SettingsActivity.class);
