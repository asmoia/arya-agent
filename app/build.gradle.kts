...
android {
    ...
    defaultConfig {
        ...
        minSdk = 28
        targetSdk = 36
        versionCode = readLocalOrEnvInt("POKECLAW_VERSION_CODE", 124)
        versionName = readLocalOrEnvString("POKECLAW_VERSION_NAME", "1.2.19")
    ...
    onVariants { variant ->
        variant.outputs.forEach { output ->
            if (output is com.android.build.api.variant.impl.VariantOutputImpl) {
                ...
                val fileName = "آریا_v${versionName}_${getDateTime()}.apk"
